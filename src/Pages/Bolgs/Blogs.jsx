    ...
    return (
        <div>
            ...
            <div>
                ...
                <div className='m-3 py-5'>
                    <h1 className='text-2xl py-2'>What is MongoDB aggregate and how does it work?</h1>
                    <p className='font-semibold'>
                        ...
                        <br />
                        The aggregate operation takes an array of pipeline stages as input. Each stage performs a specific operation on the data and passes the modified data to the next stage in the pipeline. Here are some commonly used stages in an aggregation pipeline:
                    </p>
                </div>
            </div>
        </div>
